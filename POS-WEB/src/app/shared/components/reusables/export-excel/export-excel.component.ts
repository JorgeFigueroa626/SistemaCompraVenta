...
export class ExportExcelComponent implements OnInit {
  icCloudDowload = IconsService.prototype.getIcon("icCloudDowload");
  ...
  constructor(
    public _downloadXslxServices: DownloadXslxService,
  ...
  download() {
    Swal.fire({
      title: `Confirma`,
      text: "Esta accion descargara los registros, ignorando la paginacion",
      icon: "warning",
